...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Juic App'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  var detail = "Introducing the all-new platform,entrepreneurs and ecommerce professionals. strategies and tactics to help your business. ";

  @override
  void initState() {
    _products.add(Product(
        "Apple Juice", detail, "\$3.9", "assets/products/apple.jpg", 898,
        bgColor: const Color(0xfff57888), nameColor: const Color(0xff9a0c1e)));
    _products.add(Product(
        "Green Apple Juice", detail, "\$3.9", "assets/products/green.jpg", 1000,
        bgColor: const Color(0XFFdeefa3), nameColor: const Color(0XFF86a51d)));
    _products.add(Product(
        "Mango Juice", detail, "\$3.9", "assets/products/mango.jpg", 1500,
        bgColor: const Color(0xfffde197), nameColor: const Color(0xffeeae04)));
    _products.add(Product(
        "Papaya Juice", detail, "\$3.9", "assets/products/papaya.jpg", 459,
        bgColor: const Color(0XFFfecdaf), nameColor: const Color(0xffae4302)));
    _products.add(Product(
        " StrawberryJuice", detail, "\$4.2", "assets/products/straw.jpg", 120,
        bgColor: const Color(0XFFfca9ad), nameColor: const Color(0Xffc40610)));
    _products.add(Product(
        "Orange Juice", detail, "\$1.9", "assets/products/orange.jpg", 2000,
        bgColor: const Color(0Xfffecb7e), nameColor: const Color(0XFFe38902)));
    _products.add(Product(
        "Watermelon Juice", detail, "\$5.0", "assets/products/watermelon.jpg",
        898, bgColor: const Color(0XFFfca9ad),
        nameColor: const Color(0Xffc40610)));
    super.initState();
  }
...
//filter
        ...
        SizedBox(
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return currentCategoryIndex == index ? _buildCurrentCategory(
  ...
  _buildCurrentCategory(int index) {
    return Container(
